...
export default function CreateBDI() {
  const {
  ...
  const handleSubmit = async (e) => {
    ...
    if (json.success === true) {
      toast.success("BDI Created successfully.");
    } else {
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="form-field">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="Mobile No of the BDI"
                    required
                  />
                </div>
                <div className="form-field">
                ...
                <div className="form-field">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="Password of the BDI Account"
                    required
                  />
                </div>
                <div className="form-field">
