              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="form-field">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="Employee ID of the TL"
                    required
                  />
                </div>
                <div className="form-field">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="Mobile No of the TL"
                    required
                  />
                </div>
                <div className="form-field">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="Whatsapp No of the TL"
                    required
                  />
                </div>
                <div className="form-field">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="Password of the TL Account"
                    required
                  />
                </div>
                <div className="form-field">
